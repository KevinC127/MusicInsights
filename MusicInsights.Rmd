...
Person <- tibble(pseudonym=survey$pseudonym, time_submitted=survey$time_submitted, sex=survey$sex, academic_level=survey$academic_level, Major=survey$academic_major)

Favorite_Song <- tibble(pseudonym=survey$pseudonym, favorite_song=survey$favorite_song, favorite_song_artist=survey$favorite_song_artist, link=survey$favorite_song_link)
